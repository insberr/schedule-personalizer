...
function ScheduleEntry(props: ScheduleEntryProps) {
    ...
    >
    <Row onClick={()=> { !presentationMode && setOpen(!props.mini && !open) }} className="classRow">
    ...
    <Row onClick={() => {!presentationMode && setOpen(!props.mini && !open)}} className={"classInfoCollapse"}>
