                    ...
                    <ListGroup variant="flush">
                        { Object.entries(customizations.theme.colors.schedule).map((c, i) => {
                            ...
                            <ListGroup.Item key={'scheduleColors'+c[0]+i}>
                                <Center>
                                    ...
                                    { colorPickers[c[0]] ? <div style={{ 'position': 'absolute', 'zIndex': '2' }}>
                                    ...
                                    <Container style={{ width: "80vw", maxWidth: "900px" }}>
                                        <Row className="crow">
                                            <ScheduleEntry viewDate={new Date()} sch={[]} period={{ classID: parseInt(c[0]), period: 0, name: 'Example', room: '100', teacher: { name: 'Crabby', email: 'CrabbyPatty@school.edu', id: 'madeupid'}, startTime: getTimeW(0, 0), endTime: getTimeW(1, 0) }} mini={false} key={'scheduleColors'+c[0]+i} />
                                        </Row>
                                    </Container>
                                </Center>
                            </ListGroup.Item>)
                        ...
                        <ListGroup.Item>
                            <Center>
                                ...
                                <Container style={{ width: "80vw", maxWidth: "900px" }}>
                                    <Row className="crow">
                                        <ScheduleEntry viewDate={new Date()} sch={[]} period={{ classID: ClassIDS.Null, period: 1, name: '', room: '100', teacher: { name: 'Crabby', email: 'CrabbyPatty@school.edu', id: 'madeupid'}, startTime: dateToTime(new Date()), endTime: dateToTime(new Date()) }} mini={false} key={'scheduleColors'+customizations.theme.colors.currentClass} />
                                    </Row>
                                </Container>
                            </Center>
                        </ListGroup.Item>
