...
export function AddToHomeScreen(props: { setStage: (s: number) => void }) {
    return (<Center className="text-center full-center">
        ...
        <div style={{'color':'crimson'}} className='mt-2'>{ fromVOne === 'true' ? 'Looks like you have the v1 app installed still. We suggest that you delete it and add "https://schedule.insberr.com" to your homescreen.' : '' }</div>
