...
const migrations = {
    ...
    2: (state: any) => {
        ...
        return {
            ...
            customization: {
                ...state.customization,
                theme: { ...state.customization.theme, colors: colors },
            },
        };
    },
    3: (state: any) => {
        return {
            ...
            customization: {
                ...state.customization,
                theme: { ...state.customization.theme, icons: defaultCustomizations.theme.icons },
            },
        };
    },
    4: (state: any) => {
        return {
            ...
            schedule: {
                ...state.schedule,
                lunch: state.schedule.lunch === 0 ? 1 : state.schedule.lunch,
            },
        };
    },
    5: (state: any): any => {
    ...
    6: (state: any): any => {
        return {
            ...state,
            customization: { ...state.customization, tutorial: defaultCustomizations.tutorial },
        };
    },
    7: (state: any): any => {
        return { ...state };
        ...
        return {
            ...
            customization: {
                ...
                theme: {
                    ...
                    colors: {
                        ...state.customization.theme.colors,
                        schedule: {
                            ...state.customization.theme.colors.schedule,
                            [ClassIDS.Passing]: defaultCustomizations.theme.colors.schedule[ClassIDS.Passing],
                        },
                    },
                },
            },
            ...
            customization: {
                ...
                theme: {
                    ...
                    colors: {
                        ...
                        schedule: {
                            ...state.customization.theme.colors.schedule,
                            [ClassIDS.Custom]: defaultCustomizations.theme.colors.schedule[ClassIDS.Custom],
                        },
                    },
                },
            },
...
const sentryReduxEnhancer = Sentry.createReduxEnhancer({
    ...
    stateTransformer: (state) => {
        return JSON.stringify({
            ...state,
            studentvue: redactStructure(state.studentvue || {}),
            stv: redactStructure(state.stv || {}),
        });
    },
    actionTransformer: (action) => {
        if (action.type == 'persist/REHYDRATE') {
            return {
                ...
                payload: {
                    ...action.payload,
                    studentvue: redactStructure(action.payload?.studentvue || { nodata: 'data' }),
                    stv: redactStructure(action.payload?.stv || { nodata: 'data' }),
                },
            };
